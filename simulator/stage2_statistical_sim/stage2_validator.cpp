                       ...
                       std::string &err)
{
    ...
    out << "- DDC_acquired_len: " << cfg.acquired_pulse_len << "\n";
    ...
    const int generated_beam_count = cfg.sim.beam_count > 0
        ? cfg.sim.beam_count
        : cfg.radar.beam_count - cfg.sim.beam_start_1based + 1;
    out << "- generated_beam_subset: " << cfg.sim.beam_start_1based << ".."
        << (cfg.sim.beam_start_1based + generated_beam_count - 1) << "\n";
    ...
    out << "- continuous_area_precompressed_packets: "
        << stats.continuous_area_precompressed_packets << "\n";
    out << "- continuous_area_raw_lfm_packets: "
        << stats.continuous_area_raw_lfm_packets << "\n";
    out << "- output_signal_domain: "
